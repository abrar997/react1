        ...
        <footer >
            <div className="container py-5">
                <div className="row py-4">
                    <div className="col-lg-4 col-md-6  mb-lg-0"><img src="img/logo.png" alt="" width="180" className="mb-3" />
                        <p className =" text-muted mt-4 pt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
            ...
            <div className=" py-4 copyright">
                <div className="container text-center">
                    <p className="text-muted mb-0 py-2">© 2021 Abrar Muthanna Company</p>
                </div>
            </div></footer>
    )
}
